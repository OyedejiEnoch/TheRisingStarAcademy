...
const HomeSingleCourseCard = ({course}:Props) => {
  return (
    ...
    <div className="flex items-center justify-between px-4 py-2">
      ...
      <span className="flex items-center text-sm text-gray-500 gap-2"><IoMdBook size={24} className="text-[#fca3c4]" />{course.subCourses?.length} Sub courses</span>
    </div>

    <hr />
    <div className="flex justify-end p-2">
        <Link to={`/courses/${course._id}`}><span 
...
export default HomeSingleCourseCard