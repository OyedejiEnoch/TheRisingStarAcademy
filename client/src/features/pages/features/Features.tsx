...
const Features = () => {
  return (
    <section className="px-6 py-4  bg-white mt-8">
        <div className="flex flex-col w-full gap-6 items-center justify-center animate__fadeInUp  animate__delay-2s ">
            <div className="flex flex-col gap-2 items-center justify-center animate__fadeIn  animate__delay-3s">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 animate__fadeInUp  animate__delay-3s">

                <div className="bg-white flex flex-col w-[350px] border border-gray-100 rounded-lg animate__fadeInUp  animate__delay-3s">
